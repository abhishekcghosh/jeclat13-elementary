<?php
	...
	else if(strtolower(substr($bUA,0,9))=="googlebot") { $isGood=true; }	
	if($isGood==false)
	{ 
		//oh shit!
		//redirect to alert
...
<body>
    ...
    <a href="http://www.popularwebsiteawards.com?URL=jeclat.in" target="_blank">
    	<img class="awardImage awardPWA" src="assets/awards/PWA_Award.png">
    </a>
    
    <a href="http://www.cssdesignawards.com/css-web-design-award-winner.php?id=16717" target="_blank">
        <img class="awardImage awardCSSDA" src="assets/awards/css-design-award-dark.png" height="72" width="86">
    </a>

	<a href="http://cssreel.com/Website/jeclat-13" target="_blank">
		<img class="awardImage awardCSSReel" src="assets/awards/cssreel_winner_black.png" height="30" width="70">
    </a>
    ...
    <!-- level 1: z-index 0 -->
        <img id="world_map" class="mapImage" src="assets/whitemap-ink.svgz" />
                    ...
                    <table class="detailsPaneContent" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="600px" valign="bottom" >
                                ...
                                -->
                                <img src="assets/routine.jpg" height="303" width="662"/>
                        ...
                        <tr>
                            ...
                            <td width="550px">
                            	...
                            	<div class="detailsSponsorImages">
                                	<img src="assets/past-sponsors.png" height="900" width="532"/>
                                </div>
