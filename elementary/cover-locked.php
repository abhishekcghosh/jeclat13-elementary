    ...
    <div class="rightDataPane">
    	<div class="dataPane" id="dataPane_start">
            ...
            <div class="paneContent" id="start_signin">
            	elementary begins 
                <br>
                <strong style="font-size: 32px">7 March 2013</strong>
                <br><br>
                You will be able to sign in and start from<br>
                <strong>7 March 2013 00:00:00 IST</strong>
                <br><br>
                <br>
                <span >If you are not yet registered, you can <a class="paneLinks" id="paneLink_signup"><strong>sign up here</strong></a></span>.
            </div>
            <div class="paneContent" id="start_signup" style="display: none;">
            	Create a JECLAT 13 account
            	<form name="signup" method="post" action="register-locked.php">
                	<br>
                	Full Name<br>
